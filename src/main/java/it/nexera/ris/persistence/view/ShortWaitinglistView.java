...
@Table(name = "short_waitinglist_view")
@View(sql = ShortWaitinglistView.QUERY)
public class ShortWaitinglistView extends BaseWaitinglistView {
    protected static transient final Logger log = LogManager.getLogger(BaseHelper.class);

    protected static final String QUERY = "CREATE OR REPLACE VIEW short_waitinglist_view "
            + "AS SELECT     "
            ...
            + "FROM PATIENT p LEFT JOIN RADIOLOGY_EXAM_REQUEST_SHORT request "
