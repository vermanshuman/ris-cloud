            ...
            editor.ui.addRichCombo( 'Zoom',
                {
                    ...
                    onRender: function() {
                        ...
                        editor.on('instanceReady', function(){
                            this.onClick(this.findCookie('profile_zoom_value'));
                        }, this);
                        editor.on('fixWidth', function(){
                            this.fixWidthCKEditor('profile_zoom_value');
                        }, this);
                    },
                    ...
                    fixWidthCKEditor: function(name) {
                        var newWidth = parseInt(($(editor.editable().$.parentElement).width() - 27)/(this.lastValue/100), 10);
                        $(editor.editable().$).css({width: newWidth + 'px'});
                    }
                });
        } //Init
    } );
